...
const translations = {
    'zh-CN': {
        ...
        contactUs: '联系我们',
        aboutUsTitle: '关于我们',
        aboutUsContent: 'Fuel Cell Calculator 是一个专业的燃料电池计算工具，旨在为工程师和研究人员提供准确的计算服务。',
        contactUsTitle: '联系我们',
    ...
    'en': {
        ...
        aboutUsContent: 'Fuel Cell Calculator is a professional fuel cell calculation tool designed to provide accurate calculation services for engineers and researchers.',
    ...
    'ja': {
        ...
        aboutUsContent: 'Fuel Cell Calculator は、エンジニアや研究者に正確な計算サービスを提供するために設計された専門的な燃料電池計算ツールです。',
    ...
    'ko': {
        ...
        contactUs: '연락처',
        aboutUsTitle: '회사 소개',
        aboutUsContent: 'Fuel Cell Calculator는 엔지니어와 연구자에게 정확한 계산 서비스를 제공하도록 설계된 전문 연료전지 계산 도구입니다。',
        contactUsTitle: '연락처',
